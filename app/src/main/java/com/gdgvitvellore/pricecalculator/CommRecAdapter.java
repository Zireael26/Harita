...
public class CommRecAdapter extends RecyclerView.Adapter<CommRecAdapter.CommodityViewHolder> {
    ...
    public class CommodityViewHolder extends RecyclerView.ViewHolder {
        ...
        public CommodityViewHolder(View itemView) {
            ...
            rateTextView = itemView.findViewById(R.id.rateVal);
            qtyTextView = itemView.findViewById(R.id.weightVal);
            priceTextView = itemView.findViewById(R.id.costVal);
            nameTextView = itemView.findViewById(R.id.nameOfVegetable);
        }
    }
}
